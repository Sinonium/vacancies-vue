<template>
  <div class="cart-teach">
    <div class="cart-teach__about_teach col-4">
      ...
      <img :src="teacherInfo.photo" alt="Image teacher" />
    ...
    <div v-if="moreInfo" class="cart-teach__features_teach col-5">
      ...
      <span> {{ teacherInfo.description.skills }} </span>
      <p>
        {{ teacherInfo.description.aboutMe }}
      </p>
      <p>
        {{ teacherInfo.description.education }}
      </p>
    </div>
...
export default {
  props: ['moreInfo', 'popa', 'teacherInfo'],
  setup(props) {
