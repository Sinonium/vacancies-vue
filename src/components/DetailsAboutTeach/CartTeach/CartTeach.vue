<template>
   <div class="cart-teach">
      <div class="cart-teach__about_teach col-4">
         ...
         <img :src="teacherImage" alt="Image teacher" />
         <ul class="cart-teach__about_teach_list">
            <li
               v-for="item in teacherDataArrNotDataBase"
               :key="item.title"
      ...
      <div v-if="moreInfo" class="cart-teach__features_teach col-5">
         ...
         <p>
            Newly married in Cleveland Ohio, Tony is primarily focused these
            days on trying to be a good husband. While inexperienced at that,
            he's quite experienced in all things web.
         </p>
         <p>
            Tony has been programming since he was 12 years old, and got into
            web sites and web application development at 16. After graduating
            with a Computer Science degree from Case Western Reserve University.
         </p>
      </div>
...
import { onMounted } from '@vue/runtime-core';
   export default {
      ...
      setup(props) {
         ...
         // const teacherDataArr2 = props.moreInfo.teacherData
        ...
        setTimeout(() => {
          console.log(props.popa);
        }, 1000);

         return {
            teacherImage: require("@/assets/img/DetailsAboutTeach/imageTeach.png"),
            // teacherDataResult,
            // teacherDataArr2,
            teacherDataArrNotDataBase,
         };
      },
   };
</script>
...
<style lang="scss" scoped>
   ...
   @media screen and (max-width: 1440px) {
      ...
      .cart-teach__about_teach_list-item .first__span {
         font-size: 1.2vw;
      }
   ...
   @media screen and (max-width: 769px) {
      ...
      .cart-teach__about_teach_list-item span {
   ...
   @media screen and(max-width: 426px) {
      ...
      .cart-teach {
         ...
         width: vmin(330);
         display: flex;
         padding: 1.1875vmin 0.5vmin 2.625vmin 0.125vmin;
         background: $white;
         border-radius: 10px;
         box-shadow: 0 2px 5px rgba(54, 61, 77, 0.05);
         flex-wrap: wrap;
         ...
         &__features_teach {
            margin-left: 14.6vmin;
            h2 {
               @include font(vmin(14), bold, 30px, $greyBlue50);
            }
            p,
            span {
