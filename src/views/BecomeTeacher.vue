<template>
  <form @submit.prevent="handleSubmit()" class="become-teacher">
    ...
    <div class="create-teacher">
      <div class="create-teacher__description">
        <h4 class="create-teacher__title">
        ...
        <input
          class="url-input"
          type="text"
          placeholder="https://ibb.co/Tm5dJbY"
          v-model="imageURL"
        />
        <p class="create-teacher__instruction">
          To get the URL click <a href="https://ru.imgbb.com/">here</a>.
        </p>

        <h4 class="create-teacher__title">
          Write a little about yourself (work, hobby ...)
        </h4>
        <textarea
          onkeyup="this.value=this.value.replace(/^\s/,'')"
          name="comment"
